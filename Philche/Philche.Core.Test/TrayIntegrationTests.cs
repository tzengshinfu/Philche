...
public sealed class TrayIntegrationTests
{
    ...
    [Fact(DisplayName = "╰参俱代刚Gui Mode Scan Arguments Are Accepted Without Cli Flag")]
    ...
    [Fact(DisplayName = "╰参俱代刚Handle Existing Instance Activation Queues Gui Scan Paths")]
